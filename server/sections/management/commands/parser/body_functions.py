...
from sections.management.commands.parser import shared as shared_functions
...
def has_primary_indicator(instructor):
    return '(P)' in instructor


def strip_primary_indicator(instructor):
...
def parse_datadisplaytable(dddefault: bs4.BeautifulSoup):
    ...
    return meetings, all_mentioned_instructors
