...
import goodbullapi.models.sections
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution_of_hours', models.CharField(blank=True, max_length=60, null=True)),
                ('description', models.TextField(blank=True, max_length=500, null=True)),
                ('prereqs', models.TextField(blank=True, null=True)),
                ('coreqs', models.TextField(blank=True, null=True)),
                ...
                ('search_vector', django.contrib.postgres.search.SearchVectorField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting_days', models.CharField(max_length=7, validators=[goodbullapi.models.sections.is_valid_meeting_string])),
                ('start_time', models.TimeField(null=True)),
                ('end_time', models.TimeField(null=True)),
                ('meeting_type', models.CharField(choices=[('Lec', 'Lecture'), ('Lab', 'Laboratory'), ('Rec', 'Recitation'), ('Exa', 'Examination'), ('Dis', 'Dissertation'), ('Ind', 'Independent Study'), ('Res', 'Research')], max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Section',
            fields=[
                ...
                ('crn', models.IntegerField(verbose_name='Unique course registration number.')),
                ('section_num', models.CharField(max_length=5)),
                ('term_code', models.IntegerField(verbose_name='The term in which this course was offered.')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='goodbullapi.Course')),
                ('instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sections_taught', to='goodbullapi.Instructor')),
                ('meetings', models.ManyToManyField(related_name='meetings', to='goodbullapi.Meeting')),
            ],
            options={
